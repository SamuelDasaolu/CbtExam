                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        <div>
                            ...
                            <form method="POST" action="<?php echo route('profile_edit', ['id'=>$user_id]); ?>">
                                <table>
                                <tr>
                                        <td>
                                            Username
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="edit_username" id="" value="<?php echo $username; ?>">
                                        </td>
                                    </tr>    
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="email" class="form-control" name="edit_email" id="" value="<?php echo $email; ?>"/>
                                        </td>
                                    </tr>
